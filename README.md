...
O mini-sistema foi criado com a finalidade de colocar tudo o que eu aprendi através de cursos e materiais na internet. Trata-se de um CRUD simples de medicos e pacientes, utilizando tecnologias mais legadas do JAVA, como JDBC, JSP e Servlet. A minha intenção era conhecer mais de perto como o apache tomcat junto com um servlet orquestrador pode trabalhar com as requisições e as respostas, assim redirecionando ou encaminhando responsabilidades para outros módulos da aplicação.  
